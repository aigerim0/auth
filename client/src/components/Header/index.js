                ...
                <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
                    {
                        auth ?
                            <div className='flex '>
                                ...
                                <button    className="bg-indigo-700 hover:bg-indigo-500 text-white ml-4 py-2 px-3 rounded-lg" onClick={() => dispatch(logout())}>
                                    Logout
                                </button>
                            </div>
                            :
                   <>
                       ...
                       <Link to="/signin" className="bg-indigo-700 hover:bg-indigo-500 text-white ml-4 py-2 px-3 rounded-lg">
                           Sign In
                       </Link>
                   </>
                    }
